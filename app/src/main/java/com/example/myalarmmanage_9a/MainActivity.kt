package com.example.myalarmmanage_9a
...
import com.example.myalarmmanage_9a.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(),
    ...
    private val requiresPermissionLauncher = registerForActivityResult(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            requiresPermissionLauncher.launch(Manifest.permission.POST_NOTIFICATIONS)
        }
